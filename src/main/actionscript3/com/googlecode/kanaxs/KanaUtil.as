package com.googlecode.kanaxs
{
	public final class KanaUtil
	{
		...
		public static function toHankanaCase(s:String):String
		{
			var c:Number;
			var a:Array = [];
			var m:Object = ZENKAKU_TO_HANKAKU_MAP;
		...
		public static function toZenkanaCase(s:String):String
		{
			var c:Number = 0;
			var a:Array = [];
			var m:Object = HANKAKU_TO_ZENKAKU_MAP;
		 ...
		 * 全角仮名→半角仮名への変換テーブル
		 */
		private static const ZENKAKU_TO_HANKAKU_MAP:Object =
		{
		 ...
		 * 半角仮名→全角仮名への変換テーブル
		 */
		private static const HANKAKU_TO_ZENKAKU_MAP:Object =
		{
